    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage prescriptions, inventory, and dispensing</p>
        </div>
            ...
            <CardContent>
              ...
              {loading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 mb-6">All prescriptions have been processed.</p>
                  <Button onClick={fetchPendingPrescriptions}>
                    Refresh
                  </Button>
                </div>
              ) : (
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 mb-6">
                  Manage your medicine stock, add new items, and track inventory levels.
                </p>
                <Button onClick={() => router.push("/pharmacy/stock")}>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 mb-6">
                  View the complete history of all dispensed prescriptions and medicines.
                </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 mb-6">
                  Generate reports for sales, inventory, and dispensing activities.
                </p>
