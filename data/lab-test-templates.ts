...
export const labTestTemplates = [
  ...
  {
    testCode: "BG",
    testName: "Blood Group (ABO & Rh)",
    category: "hematology",
    description:
      "Blood group testing to determine ABO type and Rh factor for transfusion compatibility and clinical use.",
    specimenType: ["blood"],
    containerType: ["EDTA tube"],
    sampleVolume: "2 mL",
    fastingRequired: false,
  ...
  },
  {
    ...
    category: "biochemistry",
    description:
      "Random blood sugar test measures glucose levels at any time without fasting. Used to monitor glucose and screen for diabetes.",
    specimenType: ["blood"],
    containerType: ["Fluoride oxalate tube"],
    sampleVolume: "2 mL",
    fastingRequired: false,
    ...
    parameters: [
      {
        parameterCode: "RBS",
        parameterName: "Random Blood Glucose",
        unit: "mg/dL",
        normalRange: "70-140",
        criticalLow: 50,
        criticalHigh: 300,
  ...
  },
  {
    ...
    category: "biochemistry",
    description:
      "Measures triglyceride levels in blood for cardiovascular and metabolic assessment.",
    specimenType: ["blood"],
    containerType: ["Plain tube"],
    sampleVolume: "3 mL",
    fastingRequired: true,
  ...
  // CLINICAL PATHOLOGY TESTS
  {
    ...
    category: "other",
    description:
      "Complete semen analysis including physical examination, microscopic examination, and morphology.",
    specimenType: ["other"],
    containerType: ["Sterile container"],
    sampleVolume: "2-5 mL",
    fastingRequired: false,
    ...
    parameters: [
      {
        parameterCode: "LIQUEFACTION_TIME",
        parameterName: "Liquefaction Time",
        unit: "min",
        normalRange: "10-30",
        group: "Physical Examination",
        methodology: "Physical examination",
      },
      {
        parameterCode: "ABSTINENCE_DAYS",
        parameterName: "Abstinence Days",
        unit: "days",
        normalRange: "3-7",
        group: "Physical Examination",
        methodology: "History",
      ...
      {
        parameterCode: "TOTAL_SPERM_COUNT",
        parameterName: "Total Sperm Count",
        unit: "million/mL",
        normalRange: ">15",
        group: "Microscopic Examination",
        methodology: "Microscopic examination",
      ...
      {
        parameterCode: "SLUGGISH",
        parameterName: "Sluggish",
        unit: "%",
        normalRange: "N/A",
        group: "Microscopic Examination",
        methodology: "Microscopic examination",
      ...
      {
        parameterCode: "NORMAL_MORPHOLOGY",
        parameterName: "Normal Morphology",
        unit: "%",
        normalRange: ">40",
        group: "Morphology",
        methodology: "Microscopic examination",
      ...
      {
        parameterCode: "ABNORMAL_MORPHOLOGY",
        parameterName: "Abnormal Morphology",
        unit: "%",
        normalRange: "N/A",
        group: "Morphology",
        methodology: "Microscopic examination",
  ...
  },
  {
    ...
    parameters: [
      {
        parameterCode: "ASO",
        parameterName: "Anti-Streptolysin O",
        unit: "IU/mL",
        normalRange: "<200",
        criticalLow: 0,
        criticalHigh: 1000,
  ...
  },
  {
    ...
    category: "serology",
    description: "Measures inflammation marker in blood.",
    specimenType: ["blood"],
    containerType: ["Plain tube"],
    sampleVolume: "3 mL",
    fastingRequired: false,
