// app/components/receptionist/ReceptionistRadiologyTable.tsx
...
interface ReceptionistRadiologyTableProps {
  requests: RadiologyRequest[];
  loading: boolean;
  searchQuery: string;
  onProcessPayment: (request: RadiologyRequest) => void;
  onViewBilling: (request: RadiologyRequest) => void;
}

export function ReceptionistRadiologyTable({
  requests,
  loading,
  searchQuery,
  onProcessPayment,
                ...
                <TableCell className="text-right">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem onClick={() => onViewBilling(request)}>
